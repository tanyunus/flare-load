...
const BUNDLE_MAP = {
    'includes/dist/main/fp-media-library-grid.js': [
        'includes/assets/scripts/modules/UploadManager.ts',
    ],
    'includes/dist/main/fp-media-new.js': [
        'includes/assets/scripts/modules/UploadManager.ts',
    ],
    'includes/dist/main/fp-post.js': [
        'includes/assets/scripts/modules/UploadManager.ts',
        'includes/assets/scripts/main/fp-post.tsx',
    ],
};
